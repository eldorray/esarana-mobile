<div class="animate-fade-in">
    <section class="pt-3 mb-5">
        <div class="flex items-center gap-3 mb-4">
            <a href="{{ route('inventaris.bahan.index') }}" wire:navigate class="icon-container-sm bg-surface-container-high active:scale-95 transition-transform">
        ...
        <div class="{{ $bahan->isStokRendah() ? 'bg-gradient-to-br from-tertiary to-tertiary-container' : 'hero-gradient' }} rounded-2xl p-6 text-white relative overflow-hidden">
            ...
            <div class="relative z-10">
                ...
                <div class="bg-white/20 rounded-full h-2.5 overflow-hidden">
                    <div class="h-full bg-white/80 rounded-full" style="width: {{ $pct }}%"></div>
                </div>
                <div class="flex items-center justify-between mt-2">
                    ...
                    <span class="inline-flex items-center gap-1 bg-white/20 px-2.5 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider">
                        <span class="material-symbols-outlined text-[12px]">warning</span> Stok Kritis
                    </span>
                    @else
                    <span class="inline-flex items-center gap-1 bg-white/20 px-2.5 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider">
                        <span class="material-symbols-outlined text-[12px]">check_circle</span> Cukup
                    </span>
                    @endif
                </div>
            </div>
    ...
    <section class="mb-5">
        <div class="grid grid-cols-2 gap-3">
            <div class="card-elevated p-4">
                ...
                <p class="text-base font-extrabold text-on-surface font-headline">Rp {{ number_format($bahan->harga_satuan, 0, ',', '.') }}</p>
            ...
            <div class="card-elevated p-4">
                ...
                <p class="text-base font-extrabold text-primary font-headline">Rp {{ number_format($bahan->harga_satuan * $bahan->stok, 0, ',', '.') }}</p>
    ...
    <section class="mb-5">
        ...
        <div class="card-elevated overflow-hidden">
            <div class="divide-y divide-surface-container-high">
                ...
                <div class="flex items-center gap-3 px-4 py-3.5">
                    <span class="material-symbols-outlined text-on-surface-variant text-[18px]">update</span>
                    <div>
            ...
            <div class="flex items-center gap-3 px-4 py-4">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <p class="text-[11px] text-on-surface-variant mt-0.5">Lantai {{ $bahan->ruangan->lantai }}
                        @if($bahan->ruangan->kapasitas) • Kapasitas {{ $bahan->ruangan->kapasitas }} orang @endif
                    </p>
                </div>
    ...
    <section class="mb-8">
        <a href="{{ route('inventaris.bahan.edit', $bahan) }}" wire:navigate
           class="btn-primary w-full py-3 text-sm flex items-center justify-center gap-2">
            <span class="material-symbols-outlined text-sm">edit</span> Edit Data Bahan
        </a>
    </section>
    @endcan

    <p class="text-[11px] text-on-surface-variant text-center mb-8">
