<div class="animate-fade-in">
    <section class="pt-3 mb-6">
        <a href="{{ route('inventaris.bahan.index') }}" wire:navigate class="text-primary text-sm font-semibold flex items-center gap-1 mb-3 active:opacity-70 transition-opacity">
            <span class="material-symbols-outlined text-lg">arrow_back</span> Bahan Habis Pakai
        </a>
        <h1 class="text-2xl font-extrabold tracking-tight text-on-surface font-headline">Tambah Bahan</h1>
        <p class="text-on-surface-variant text-sm mt-0.5">Input stok bahan habis pakai baru ke inventaris.</p>
    </section>
    ...
    <form wire:submit="save" class="space-y-4">
        <div>
            ...
            <input wire:model="nama" type="text" class="input-precision" placeholder="Contoh: Kertas HVS A4">
        ...
        <div class="grid grid-cols-2 gap-3">
            <div>
                <label class="text-xs font-semibold text-on-surface-variant uppercase tracking-wider block mb-2">Stok Awal <span class="text-error">*</span></label>
                <input wire:model="stok" type="number" min="0" class="input-precision" placeholder="0">
        ...
        <div class="grid grid-cols-2 gap-3">
            <div>
                ...
                <input wire:model="stok_minimum" type="number" min="0" class="input-precision" placeholder="5">
            ...
            <div>
                ...
                <input wire:model="harga_satuan" type="number" min="0" step="100" class="input-precision" placeholder="0">
